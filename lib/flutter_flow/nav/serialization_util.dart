  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetAllNotesRow:
            return GetAllNotesRow(data);
          case FilteredNotesRow:
            return FilteredNotesRow(data);
          case SearchResultsRow:
            return SearchResultsRow(data);
          case GetUserDetailsRow:
            return GetUserDetailsRow(data);
          default:
            return null;
        }
