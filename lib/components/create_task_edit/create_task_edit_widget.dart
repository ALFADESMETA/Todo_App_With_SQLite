                              ...
                              FFButtonWidget(
                                onPressed: () async {
                                  await SQLiteManager.instance.updateNote(
                                    ...
                                    isCompleted: _model.checkboxValue! ? 1 : 0,
                                    id: widget.todoRef!.id,
                                  );
                                  context.safePop();
                                },
                                text: 'Update Task',
